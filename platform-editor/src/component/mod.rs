...
use sdl3::{mouse::MouseButton, rect::{Point, Rect}, render::{BlendMode, FPoint, FRect}};
...
const BACK_BUTTON_INITIAL_SIZE: f32 = 60.0;
...
impl Render for BackButtonBase {
    fn render(&self, data: &mut RenderData) -> DrawResult {
        ...
        let size = BACK_BUTTON_INITIAL_SIZE * scale_multiplier;
...
impl Logic for BackButtonBase {
    fn run_logic(&mut self, data: &mut LogicData) {
        ...
        let hovered = distance_sq <= BACK_BUTTON_INITIAL_SIZE * BACK_BUTTON_INITIAL_SIZE;
